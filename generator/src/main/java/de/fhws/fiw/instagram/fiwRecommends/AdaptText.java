...
public class AdaptText
{
	...
	{
		textSpecificationInput.setFreeSpaceForText( ImageRulesFIWRecommends.freeSpaceForText);
	}
	...
	private void setMinMaxSizesText(){
		setMaxSize( ImageRulesFIWRecommends.maxTextSizeText);
		setMinSize( ImageRulesFIWRecommends.minTextSizeText);
	}
	...
	private void setMaxLinesOfText(){
		textSpecificationInput.setMaxLinesOfText( ImageRulesFIWRecommends.maxLinesOfText );
	}
	...
	private void setFontInInputObject(){
		textSpecificationInput.setFont( ImageRulesFIWRecommends.font);
	}
