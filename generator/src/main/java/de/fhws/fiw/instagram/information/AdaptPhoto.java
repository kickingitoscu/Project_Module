...
{
	private int targetWidth = ImageRules.pictureWidth-(2*ImageRulesInformation.frame);
	private int targetHeight = ImageRules.pictureHeight-(2*ImageRulesInformation.frame);
	...
	private void configureGraphics( ) {
		image = new BufferedImage( targetWidth, targetWidth, BufferedImage.TYPE_INT_RGB);
